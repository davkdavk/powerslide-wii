...
{
#if defined(WII) || defined(__wii__)
    WiiGX::Renderer::getInstance().presentProbeColor(16, 16, 156, 255);
#endif

    loadCommonTextures(pfLoaderGameshell);

#if defined(WII) || defined(__wii__)
    WiiGX::Renderer::getInstance().presentProbeColor(16, 16, 148, 255);
#endif

    createBackgroundTextures(pfLoaderGameshell, loaderListener);

#if defined(WII) || defined(__wii__)
    WiiGX::Renderer::getInstance().presentProbeColor(16, 16, 140, 255);
#endif
...
{
#if defined(WII) || defined(__wii__)
    WiiGX::Renderer::getInstance().presentProbeColor(16, 16, 160, 255);
#endif
...
#if defined(WII) || defined(__wii__)
    WiiGX::Renderer::getInstance().presentProbeColor(16, 16, 128, 255);
#endif
...
#if defined(WII) || defined(__wii__)
    WiiGX::Renderer::getInstance().presentProbeColor(16, 16, 96, 255);
#endif
...
#if defined(WII) || defined(__wii__)
    WiiGX::Renderer::getInstance().presentProbeColor(16, 16, 64, 255);
#endif
...
#if defined(WII) || defined(__wii__)
    WiiGX::Renderer::getInstance().presentProbeColor(16, 16, 32, 255);
#endif
...
void UIMainMenu::frameStarted(const Ogre::FrameEvent &evt)
{
    ...
    if (mCurrentState == State_Options_Credits_Video)
    {
        ...
        else
        {
            ...
            {
                mLabelCredits->show();
                setMainBackgroundMaterial("Test/MainBackgroundGT");
            }
        }
    }
    ...
    if (mCurrentState == State_Options_About_Video)
    {
        ...
        else
        {
            ...
            {
                mLabelAbout->show();
                setMainBackgroundMaterial("Test/MainBackgroundInitGamma");
            }
        }
    }
}
