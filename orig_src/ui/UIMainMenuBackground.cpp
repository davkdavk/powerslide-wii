...
{
#if defined(WII) || defined(__wii__)
    WiiGX::Renderer::getInstance().presentProbeColor(16, 16, 152, 255);
#endif
...
#if defined(WII) || defined(__wii__)
    WiiGX::Renderer::getInstance().presentProbeColor(16, 16, 146, 255);
#endif
...
#if defined(WII) || defined(__wii__)
    WiiGX::Renderer::getInstance().presentProbeColor(16, 16, 142, 255);
#endif
