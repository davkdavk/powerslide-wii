...
void UIRaceMulti::load(CustomTrayManager* trayMgr, const GameState& gameState)
{
...

    {
        ...
        mEditBoxMessage.init(screenAdaptionRelative, static_cast<Ogre::OverlayContainer*>(trayMgr->getTrayContainer(OgreBites::TL_NONE)), Ogre::Vector4(439.0f, 0.0f, 200.0f, 18.0f), 36.0f, true);
